({
    getRoledexSuggestions : function(component, event, helper) {
        ...
        toastEvent.setParams({
            "title": "Contact Linked with Draup",
            "type": 'info',
            "message": msg
        });
        ...
        action.setCallback(this, function(a) {
            if (a.getState() === "SUCCESS") {
                ...
                //console.log('ex Exists ** '+executives.length);
                //console.log('ex Exists ** '+executives.length == 1);
                //console.log('Direct Match **'+executives[0].direct_match);
                if(!isSuperUser){
                ...
                else if(executives.length == 1 && executives[0].direct_match == true){
                    console.log('from length ==1')
                    component.set("v.executiveId",executives[0].executive_id);
                    var isFromunlink = component.get('v.isFromUnlink');
                    //component.set("v.draupAccountName",executives[0].executive_name);
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if( queryParameters != null)
                {
                    ...
                    var WindowName = draupApiUrl+"/draup/authorize?client_id="+queryParameters;
